...
from tweetnook.config import BUNDLE_URL_REGEX, CLIENT_WEB_BUNDLE_BASE, DISCOVERY_PAGE_URL
...
# The other IDs below were reverified against the public Twitter/X web bundle on 2026-03-16.
FALLBACK_QUERY_IDS = {
